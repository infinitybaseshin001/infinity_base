...
<?php
$modelControlArray = array(//'../MODEL/common/rssFeed.class.php',
...
if($_GET["pos"] == "start") { //開始処理
    ...
    require_once('../VIEW/scm/q1jp.tpl.php'); //1問目設定
...
if($_POST["next1"] != "") {
    ...
    require_once('../VIEW/scm/q2jp.tpl.php'); //2問目設定
    ...
    require_once('../VIEW/scm/q3jp.tpl.php'); //3問目設定
    ...
    require_once('../VIEW/scm/q4jp.tpl.php'); //4問目設定
    ...
    require_once('../VIEW/scm/q5jp.tpl.php'); //5問目設定
    ...
    require_once('../VIEW/scm/q6jp.tpl.php'); //6問目設定
    ...
    require_once('../VIEW/scm/q7jp.tpl.php'); //7問目設定
    ...
    require_once('../VIEW/scm/q8jp.tpl.php'); //8問目設定
    ...
    require_once('../VIEW/scm/q9jp.tpl.php'); //9問目設定
    ...
    require_once('../VIEW/scm/q10jp.tpl.php'); //10問目設定
    ...
    require_once('../VIEW/scm/q11jp.tpl.php'); //11問目設定
    ...
    require_once('../VIEW/scm/q12jp.tpl.php'); //12問目設定
    ...
    require_once('../VIEW/scm/q13jp.tpl.php'); //13問目設定
    ...
    require_once('../VIEW/scm/q14jp.tpl.php'); //14問目設定
    ...
    require_once('../VIEW/scm/q15jp.tpl.php'); //15問目設定
    ...
    require_once('../VIEW/scm/resultJP.tpl.php'); //結果画面設定
